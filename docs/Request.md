...
- `headers` - the headers
- `raw` - the incoming HTTP request from Node core ([`http.IncomingMessage`](https://nodejs.org/api/http.html#http_class_http_incomingmessage)) *(you can use the alias `req`)*
- `id` - the request id
